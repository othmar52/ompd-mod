...
<link rel="icon" sizes="196x196" href="images/o_lg.png">
...
<tr>
	<td class="menu_top_left"><div class="mpd_title"><span id="logo1">O!</span><span id="logo2">MPD</span></div></td>
...
<span id="list" onclick='toggleSubMiddle("Alpha");'>list <i id="iconmenuSubMiddleMediaAlpha" class="fa fa-chevron-circle-down"></i></span>
...
<?php
	...
	$header['menu'] .= "\t" . '<a href="index.php?action=viewPopular&amp;period=overall">popular</a>';
