...
//  +------------------------------------------------------------------------+
//  | Core track search for currently playing song                           |
//  +------------------------------------------------------------------------+
//  | http://ompd.pl/song-versions					                         |
//  +------------------------------------------------------------------------+
$cfg['enable_core_track_search'] = FALSE;
...
//  +------------------------------------------------------------------------+
$cfg['current_playlist_max_displayed_items'] = 600;
...
//  +------------------------------------------------------------------------+
//  | Can be very slow on huge collections                                   |
//  +------------------------------------------------------------------------+
//  | 				                         |
//  +------------------------------------------------------------------------+
$cfg['enable_fuzzy_artist_search'] = true;
